...
class PDFAdapter(BaseAdapter):
    ...
    def __init__(self, options: Optional[Dict[str, Any]] = None):
        ...
        # For testing, we allow initialization even if Docling is not available
        # but actual processing will fail unless we use mock methods
        if DOCLING_AVAILABLE:
            self.converter = DocumentConverter()
        else:
            # Use cast to help mypy understand this is intentional
            self.converter = cast(DocumentConverter, None)
    ...
    def extract_entities(self, content: Union[str, Dict[str, Any], 'Any']) -> List[Dict[str, Any]]:
        ...
        if hasattr(content, 'export_to_markdown'):
            ...
            if not entities:
                text = str(content.export_to_markdown())
    ...
    def convert_to_markdown(self, content: Union[str, Dict[str, Any]]) -> str:
        ...
        if hasattr(content, 'export_to_markdown'):
            ...
            return self._text_to_markdown(str(content["content"]))
        elif isinstance(content, str):
    ...
    def convert_to_text(self, content: Union[str, Dict[str, Any]]) -> str:
        ...
        if hasattr(content, 'export_to_text'):
            ...
            return self._markdown_to_text(str(content["content"]))
        elif isinstance(content, str):
    ...
    def _extract_doc_metadata(self, doc: Any) -> Dict[str, Any]:
