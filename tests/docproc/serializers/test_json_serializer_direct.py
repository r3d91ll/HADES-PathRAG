"""
Direct tests for the JSON serializer module.
This file tests the JSON serializer directly, without importing the adapter modules,
to avoid dependency issues with Docling.
"""
...
# Now import just the serializer module directly
...
class TestJsonSerializerDirect(unittest.TestCase):
